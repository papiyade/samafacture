    ...
    const actions = [
      {
        ...
        color: 'blue',
        onClick: (invoice) => this.viewInvoice(invoice)
      },
      {
        label: 'Modifier',
        icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        color: 'green',
        onClick: (invoice) => this.editInvoice(invoice)
      },
      {
        label: 'PDF',
        icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        color: 'purple',
        onClick: (invoice) => this.downloadPDF(invoice)
      },
      {
        label: 'Supprimer',
        icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        color: 'red',
        onClick: (invoice) => this.deleteInvoice(invoice)
      }
    ]
