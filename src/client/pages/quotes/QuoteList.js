...
export class QuoteList {
  ...
  renderButtons() {
    ...
    const newQuoteBtn = Button.create({
      ...
      onClick: () => window.showModal('quote-modal')
    })
    ...
    const actions = [
      {
        ...
        color: 'blue',
        onClick: (quote) => window.viewItem('quote', quote.id)
      },
      {
        label: 'Modifier',
        icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        color: 'green',
        onClick: (quote) => window.editItem('quote', quote.id)
      },
      {
        label: 'Dupliquer',
        icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        color: 'purple',
        onClick: (quote) => window.duplicateItem('quote', quote.id)
      },
      {
        label: 'Supprimer',
        icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        color: 'red',
        onClick: (quote) => window.deleteItem('quote', quote.id)
      }
    ]
